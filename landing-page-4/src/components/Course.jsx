  ...
  return (
    <section className="px-4 md:px-8 py-8 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          onClick={() =>
            (window.location.href = "https://corsmat.xyz/james/courses")
          }
      ...
      >
        {courses.map((course) => (
          <SwiperSlide key={course.id}>
            <div className="relative border rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all bg-white flex flex-col sm:flex-row h-full group">
              {/* Image Section */}
              ...
              {/* Content Section */}
              <div className="p-4 sm:w-3/5 flex flex-col">
