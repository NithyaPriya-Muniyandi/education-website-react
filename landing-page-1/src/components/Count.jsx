    ...
    >
      ...
      <div className="relative z-10 container px-4 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
          <div>
            <h3 className="text-2xl md:text-7xl font-bold">500+</h3>
            <p className="mt-2 text-base md:text-lg font-medium">Satisfied Students</p>
          </div>
          <div>
            <h3 className="text-2xl md:text-7xl font-bold">300+</h3>
            <p className="mt-2 text-base md:text-lg font-medium">Online Courses</p>
          </div>
          <div>
            <h3 className="text-2xl md:text-7xl font-bold">10+</h3>
            <p className="mt-2 text-base md:text-lg font-medium">Verified Instructor</p>
          </div>
          <div>
            <h3 className="text-2xl md:text-7xl font-bold">100+</h3>
            <p className="mt-2 text-base md:text-lg font-medium">Secure & Trusted Place</p>
          </div>
        </div>
      </div>
    </section>
